...
// import requirements from '../../public/data/requirements-uds.json';

export function checkEligibilityUDS(grades: WassceeGrades, programs: any[], requirements: any[]): EligibilityResult[] {
