  ...
  for (const program of programs) {
    ...
    for (const requirement of programRequirements) {
      ...
      if (requirement.requirementComplexity === 'advanced' && requirement.admissionTracks) {
        // Use complex requirements logic from engine
        // You can import and use checkComplexRequirements if needed
        continue;
      }
      for (const combo of allAggregateCombinations) {
        ...
        // Use flexible core subject logic
        // You can import and use checkCoreSubjectsFlexible if needed
        coreEligible = true;
        coreDetails = [];
