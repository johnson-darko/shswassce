...
// import requirements from '../../public/data/requirements-ashesi.json';

export function checkEligibilityAshesi(grades: WassceeGrades, programs: any[], requirements: any[]): EligibilityResult[] {
